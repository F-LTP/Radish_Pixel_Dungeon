...
public enum HeroClass {
	...
	public void initHero( Hero hero ) {
		...
		//RingOfTenacity rot=new RingOfTenacity();
		//RingOfAccuracy roa=new RingOfAccuracy();
		//roa.identify().collect();
		//Darksword ds=new Darksword();
		//ds.identify().collect();
		//Waterwheel ww=new Waterwheel();
		//ww.identify().collect();
		//Cutterhead che = new Cutterhead();
		//che.identify().collect();
		//Holyankh ha=new Holyankh();
		//ha.identify().collect();
		//Beecomb bc = new Beecomb();
		//bc.identify().collect();
		//Glasssword gs = new Glasssword();
		//gs.identify().collect();
		//Seekingspear ss=new Seekingspear();
		//ss.identify().collect();
		//Bloodblade bb=new Bloodblade();
		//bb.identify().collect();
		EliteBadge eb=new EliteBadge();
		eb.identify().collect();
